  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6">
      <div className="mb-4 flex items-center justify-between gap-3">
        <Link href="/crm" className="inline-flex items-center gap-1.5 text-sm text-white/60 hover:text-white/90">
          <ArrowLeft size={15} /> Leads
        </Link>
        <div className="flex items-center gap-2">
          <Link href={`/crm/leads/${lead.id}/edit`} className="inline-flex items-center gap-1.5 rounded-lg border border-[var(--border)] px-3 py-1.5 text-sm text-white/80 hover:bg-white/5">
